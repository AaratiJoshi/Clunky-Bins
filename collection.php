        ...
        <nav class="navbar navbar-inverse">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- <div class="logo"> 
                            <img src="img/logo.png" alt="" >   <!--110 and 65 
                           </div> -->
                </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-12 block">
                    <div class="footer-block">
                        <h4>Address</h4>
                        <hr />
                        <p>The Maharaja Sayajirao University,Near Shastri Bridge,Fatehgunj,Vadodara,Gujarat.
                            390002.
                        </p>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12 btm-footer-links">
                    ...
                    <div class="col-md-6 col-sm-6  col-xs-12 btm-footer">
                        Developed by: Kenil patel, Dev shah , Aarati joshi, Dhyanvi Ravat
                    </div>
        </div>
    </section>
    <div id="panel">
